...
const Login = ({ handleLogin }) => {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center rounded-lg">
      <div className="border-2 rounded-xl border-white shadow-lg shadow-emerald-600 p-20">
        <form
          onSubmit={(e) => {
            submitHandler(e);
          }}
